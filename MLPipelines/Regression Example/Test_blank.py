...
def loadData(size):
    ...
    # Use univariate selection to find the best features
    featureSelect(df, 7)
    ...
    # Here we also split into train/test data. The train data is used to train the model,
    # And once it is trained, we test it on the test data
...
def crossValidation(X_train, y_train):
    ...
    # Use cross-validation to find the best algorithm, and return it
